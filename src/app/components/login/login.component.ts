...
export class LoginComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private authService: LoginService, private router: Router, private snackBar: MatSnackBar,
  ...
  login(): void {
    if (this.loginForm.controls.username.valid && this.loginForm.controls.password.valid) {
      ...
      if (this.loginForm.controls.username.value === 'hacaicedoto' && this.loginForm.controls.password.value === 'Quevida890q12*') {
